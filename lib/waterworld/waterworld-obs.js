...
var Agent = function() {
  ...
  for(var k=0;k<this.num_eyes;k++) { this.eyes.push(new Eye(k*eyeAngle)); }
  ...
  this.last_state_data = Array.apply(null, Array(this.num_states)).map(Number.prototype.valueOf,-1);
